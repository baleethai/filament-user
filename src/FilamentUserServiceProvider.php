...
use Baleethai\FilamentUser\Commands\FilamentUserCommand;
use Baleethai\FilamentUser\Testing\TestsFilamentUser;
...
class FilamentUserServiceProvider extends PackageServiceProvider
{
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('baleethai/filament-user');
            });
    ...
    {
        return 'baleethai/filament-user';
    }
